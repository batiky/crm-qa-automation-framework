...
import com.maximus.crm.pages.TMViewProjectPage;
...
import com.maximus.crm.pages.TMProjectListPage;
import com.maximus.crm.pages.TMSearchProjectPage;
...
public class ProjectSearchStepDefs {
    ...
    /*this method distinguishes what search field should be used*/
    ...
    public void i_search_for_a_project_by_value(String field, String value) {
        ...
        browserUtils.waitForVisibility(tmProjectListPage.projects.get(0), 3000);
        switch (field) {
            case "state":
    ...
    public void i_should_see_all_projects_with_value(String field, String value) {
        ...
        for (i = 0; i <= tmProjectListPage.projects.size() - 1; i++) {
            // this explicit wait allows the project details to be loaded
            browserUtils.waitForVisibility(tmProjectListPage.projects.get(i), 3000);
            switch (field) {
                case "state":
                ...
                case "program":
                    assertTrue(value.equalsIgnoreCase((tmProjectListPage.projects.get(i).
                            findElement(By.xpath(tmProjectListPage.programNameXpath)).getText().substring(0, value.length()))));
                    break;
                case "client":
                    assertTrue(value.equalsIgnoreCase((tmProjectListPage.projects.get(i).
                            findElement(By.xpath(tmProjectListPage.clientNameXpath)).getText().substring(0, value.length()))));
                    break;
            }
    ...
    /*this method searches for a project with empty search field*/
